...
public abstract class AbstractSerialThread
{
    ...
    public object ReadMessage()
    {
        ...
        //Debug.Log("Input queue size: " + inputQueue.Count);

        object output = inputQueue.Dequeue();

        //Debug.Log("Input queue size after: " + inputQueue.Count);
        ...
        try
        {
            while (!IsStopRequested())
            {
                ...
                catch (Exception ioe)
                {
                    ...
                    Debug.LogWarning(" Port Name: " + portName + " Exception: " + ioe.Message + " StackTrace: " + ioe.StackTrace);
